...
import com.griper.griperapp.cam.internal.utils.DateTimeUtils;
...
//        hasFlash = false;
    ...
    public void setup(int mediaAction) {
        ...
        if (CamConfiguration.MEDIA_ACTION_VIDEO == mediaAction) {
            ...
            recordButton.setup(CamConfiguration.MEDIA_ACTION_PHOTO, this);
        }

        if (CamConfiguration.MEDIA_ACTION_UNSPECIFIED != mediaAction) {
    ...
    public void setMediaActionState(@MediaActionSwitchView.MediaActionState int actionState) {
        ...
        if (MediaActionSwitchView.ACTION_PHOTO == actionState) {
            recordButton.setMediaAction(CamConfiguration.MEDIA_ACTION_PHOTO);
            if (hasFlash)
                flashSwitchView.setVisibility(VISIBLE);
        } else {
            recordButton.setMediaAction(CamConfiguration.MEDIA_ACTION_VIDEO);
            flashSwitchView.setVisibility(GONE);
        }
