...
import com.griper.griperapp.cam.internal.utils.ImageSaver;
...
public final class Camera2Manager extends BaseCameraManager<String, TextureView.SurfaceTextureListener, CaptureRequest.Builder, CameraDevice>
    ...
    protected int getVideoOrientation(@CamConfiguration.SensorPosition int sensorPosition) {
        ...
        switch (sensorPosition) {
            ...
            case CamConfiguration.SENSOR_POSITION_UNSPECIFIED:
                break;
        }
    ...
    private void setFlashModeAndBuildPreviewRequest(@CamConfiguration.FlashMode int flashMode) {
        try {
