 ...
 */
public final class CamImageLoader {

    private static final String TAG = "CamImageLoader";

    private Context context;
    private String url;

    private CamImageLoader(Context context) {
        this.context = context;
    }

    public static class Builder {

        private CamImageLoader camImageLoader;

        public Builder(@NonNull Context context) {
            camImageLoader = new CamImageLoader(context);
        }

        public Builder load(String url) {
            camImageLoader.url = url;
            return this;
        }

        public CamImageLoader build() {
            return camImageLoader;
        }
    }
