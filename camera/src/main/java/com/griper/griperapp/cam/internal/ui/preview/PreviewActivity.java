package com.griper.griperapp.cam.internal.ui.preview;
...
import com.griper.griperapp.cam.internal.ui.BaseCamActivity;
import com.griper.griperapp.cam.internal.ui.view.AspectFrameLayout;
import com.griper.griperapp.cam.internal.utils.CamImageLoader;
...
public class PreviewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mediaAction == CamConfiguration.MEDIA_ACTION_VIDEO) {
            displayVideo(savedInstanceState);
        } else if (mediaAction == CamConfiguration.MEDIA_ACTION_PHOTO) {
            displayImage();
        } else {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.confirm_media_result) {
            ...
            deleteMediaFile();
            resultIntent.putExtra(RESPONSE_CODE_ARG, BaseCamActivity.ACTION_CANCEL);
        }
